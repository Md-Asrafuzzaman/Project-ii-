...
<link rel="stylesheet" type="text/css" href="http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.8.0/styles/default.min.css" />
               ...
               <ul class="nav nav-list ">
                  ...
                  <li class="rows" id="estRows">
                     <div class="lyrow">
                        ...
                        v  <div class="preview"><input type="text" value="12" class="form-control"></div>
                        <div class="view">
 ...
 <form action="{{url('postcontent')}}" method="POST">
            <input type="hidden" class="form-control" id="pwd" name="_token" value='{{csrf_token()}}'>

    <input type="hidden" class="form-control" id="pwd" name="news_id" value='{{$id}}'>
